...
namespace Mirror
{
    public class SyncIDictionary<TKey, TValue> : SyncObject, IDictionary<TKey, TValue>, IReadOnlyDictionary<TKey, TValue>
    {
        ...
        protected virtual TValue ReadValueItem(NetworkReader reader , TKey key)
        {
            return reader.Read<TValue>();
        }
        ...
        public override void OnDeserializeAll(NetworkReader reader)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                TValue obj = ReadValueItem(reader,key);
                objects.Add(key, obj);
            }
